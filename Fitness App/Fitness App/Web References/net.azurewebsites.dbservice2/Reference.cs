...
namespace Fitness_App.net.azurewebsites.dbservice2 {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="DBService2Soap", Namespace="http://tempuri.org/")]
    public partial class DBService2 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public DBService2() {
            this.Url = global::Fitness_App.Properties.Settings.Default.Fitness_App_net_azurewebsites_dbservice2_DBService2;
        ...
        /// <remarks/>
        public void insertdbAsync(string date, string name, string description, string calories, string intake) {
            this.insertdbAsync(date, name, description, calories, intake, null);
        }
        
        /// <remarks/>
        public void insertdbAsync(string date, string name, string description, string calories, string intake, object userState) {
            ...
            this.InvokeAsync("insertdb", new object[] {
                        ...
                        description,
                        calories,
                        intake}, this.insertdbOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void updatedbAsync(int id, string date, string name, string description, string calories, string intake) {
            this.updatedbAsync(id, date, name, description, calories, intake, null);
        }
        
        /// <remarks/>
        public void updatedbAsync(int id, string date, string name, string description, string calories, string intake, object userState) {
            ...
            this.InvokeAsync("updatedb", new object[] {
                        ...
                        description,
                        calories,
                        intake}, this.updatedbOperationCompleted, userState);
        }
